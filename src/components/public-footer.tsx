  ...
  return (
    <footer className="bg-[#1c1c1c] text-white font-sans mt-12 select-none">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 border-b border-[#333]">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 lg:gap-8 items-start">
          {/* Links Col 1 */}
          ...
          <div className="col-span-2 sm:col-span-1 flex flex-col gap-3.5 items-start">
