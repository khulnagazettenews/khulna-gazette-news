      ...
      <div className="space-y-2.5 pt-0.5">
        ...
        <div className="flex items-center justify-between text-gray-800 font-extrabold text-lg px-2">
          <button
            ...
            className="p-1 rounded hover:bg-gray-200 text-gray-700 transition cursor-pointer"
        ...
        <div className="grid grid-cols-2 gap-2">
          <select
            ...
            className="bg-white border border-red-200 rounded px-2 py-1 text-sm font-semibold text-gray-800 outline-none focus:ring-1 focus:ring-red-500 cursor-pointer text-center"
          >
        ...
        <div className="bg-white rounded border border-gray-150 p-2 shadow-2xs">
          {/* Weekday Labels */}
          <div className="grid grid-cols-7 text-center font-bold text-xs text-gray-600 mb-2 border-b border-gray-100 pb-1">
            {weekDaysBn.map((day) => (
            ...
            {days.map((item, idx) => {
              if (!item.isCurrentMonth) {
                return (
                  <div
                    key={idx}
                    className="py-1 text-gray-300 pointer-events-none select-none font-normal"
                  >
        ...
        <button
          ...
          className="w-full bg-[#bd081c] hover:bg-red-700 text-white font-bold py-2 px-4 rounded text-sm transition shadow-xs cursor-pointer flex items-center justify-center gap-1"
        >
          আর্কাইভ খুঁজুন
        </button>
      </div>
