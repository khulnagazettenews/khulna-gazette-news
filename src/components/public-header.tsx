  ...
  return (
    <header className="bg-white border-b border-gray-200">
      ...
      <div className="bg-gray-100 text-gray-600 text-xs py-2 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://facebook.com" target="_blank" className="hover:text-blue-600 transition" title="Facebook">
            ...
            <Link 
              href="/epaper" 
              className="flex items-center gap-1.5 bg-red-600 hover:bg-red-700 text-white font-semibold px-3 py-1 rounded transition text-[10px]"
            >
              <BookOpen size={10} />
              <span>ই-পেপার</span>
            </Link>
