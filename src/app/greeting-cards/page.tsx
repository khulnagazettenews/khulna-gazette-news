...
const cardTemplates = [
  ...
  { id: 'newyear', title: 'শুভ নববর্ষের শুভেচ্ছা', bg: 'from-red-600 to-rose-800', text: 'নতুন বছর আপনার জীবনে বয়ে আনুক অনাবিল আনন্দ ও অনন্ত অনাবিল অনাবিল অনাবিল সাফল্য।' },
